...
public class CreateNewAccount {
    ...
    @FXML
    private PasswordField PasswordTextFieldCNA;  // Changed to PasswordField
    ...
    public void handleSignUpCNA(ActionEvent actionEvent) {
        // Add logic for handling sign-up button if needed
    }
